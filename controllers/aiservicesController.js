...
const getCourseRecommendations = async (req, res) => {
    ...
    try {
        ...
        //   Step 2: Call the AI service to generate a recommendations
        const aiServiceUrl = `${process.env.AI_SERVICE_BASEURL}/recommendation/recommendations?user_id=${req.user.id}`; // Replace with actual AI service URL
     //   http://192.168.10.74:5000/recommendation/recommendations?user_id=4f9e5423-ab90-414d-802e-1283e102bc50

        const aiResponse = await axios.get(aiServiceUrl);
        console.log("ai response", aiResponse)
         const CourseIds= aiResponse.data.recommendations;
